...
if( is_sensei_active() ) {
	...
	require_once('includes/class-sensei-progress-collapse-settings.php');

	global $sensei_progress_collapse_settings;
	$sensei_progress_collapse_settings = new Sensei_Progress_Collapse_Settings(__FILE__);
}
